...
namespace FDMCApp.Controllers
{
    public class DogsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Name,Age,Breed,ImageUrl")] Dog dog)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Name,Age,Breed,ImageUrl")] Dog dog)
        {
            if (id != dog.Id)
            {
                return NotFound();
