...
namespace AirlineTickets.Controllers
{
    public class PlanesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,PlaneNumber,Model,Image,Baggage,BarOnBoard,Seats")] Plane plane)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,PlaneNumber,Model,Image,Baggage,BarOnBoard,Seats")] Plane plane)
        {
            if (id != plane.Id)
            {
                return NotFound();
